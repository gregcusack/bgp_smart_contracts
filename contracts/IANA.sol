...
contract IANA {
    ...
    function IANA_getSignatureMessageTest(uint32 ASN, address ASNOwner) pure public returns(bytes32, bytes32) {
        bytes32 base_message = keccak256(abi.encodePacked(ASN,ASNOwner));
        return (base_message, keccak256(abi.encodePacked("\x19Ethereum Signed Message:\n32", base_message)));
    }
